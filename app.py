...
Table: DATA_PLATFORM_DB.PROD_MARTS_SALES.fct_global_sales_orders
Key columns: REVENUE, COGS, PROFIT, REGION, COUNTRY_NAME,
CUST_NAME, CUST_GROUP, PRODUCT_NAME, PRODUCT_CATEGORIES,
UNIFIED_PRODUCT_NAME, SALES_REP, TEAM, REPORTING_SEGMENT,
INVOICE_DATE, ORDER_DATE, YEAR, MONTH, QUARTER,
QUANTITY_SHIPPED, SHIPPED_QTY_IN_KG, PRICE_PER_KG_IN_USD,
PROFIT_PER_KG_IN_USD, DIVISION, DATABASE, SALES_OR_ORDER

Rules:
- Return ONLY the SQL query
- No explanations, no markdown, no backticks
- Use fully qualified table name DATA_PLATFORM_DB.PROD_MARTS_SALES.fct_global_sales_orders
...
- For segment analysis use REPORTING_SEGMENT column
- For customer analysis use CUST_GROUP not CUST_NAME
- Filter SALES_OR_ORDER = 'SALES' for actual revenue, 'ORDER' for backlog
